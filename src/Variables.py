from Tools.Directories import resolveFilename, isPluginInstalled, SCOPE_CONFIG
from os import path
...
SERVICEAPP_AVAILABLE = isPluginInstalled("ServiceApp")
...
CATCHUP_TYPES = {CATCHUP_DEFAULT: CATCHUP_DEFAULT_TEXT,
                 ...
                 CATCHUP_XTREME_60: CATCHUP_XTREME_TEXT_60,
